...
import { TicketCollectionListCardCarousel } from 'src/modules/kakao-chatbot/domain/ticket-collection-list-card-carousel/ticket-collection-list-card-carousel.value-object';
